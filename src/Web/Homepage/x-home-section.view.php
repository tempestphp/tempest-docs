<section class="flex flex-col justify-center mb-20 lg:mb-[7vh] px-6 tracking-tighter">
  <div class="items-center grid grid-cols-1 lg:grid-cols-2">
    ...
    <div class="mr-6 p-2 lg:p-0">
      ...
      <div class="mt-8">
        <a :href="$linkUri" class="group no-primary rounded-lg font-medium inline-flex items-center focus:outline-hidden disabled:cursor-not-allowed aria-disabled:cursor-not-allowed disabled:opacity-75 aria-disabled:opacity-75 transition-colors px-3.5 py-2 gap-2.5 ring ring-inset ring-(--ui-border) text-(--ui-text) bg-(--ui-bg-surface) hover:bg-(--ui-bg-surface-hover) disabled:bg-(--ui-bg-surface) aria-disabled:bg-(--ui-bg-surface) focus-visible:ring-2 focus-visible:ring-(--ui-border-inverted)">
