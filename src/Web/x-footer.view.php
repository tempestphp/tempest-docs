...
<x-component name="x-footer">
  <footer class="flex items-center justify-center mb-8 gap-4 pr-(--scrollbar-width)">
    <a :href="uri([RedirectsController::class, 'github'])" class="flex items-center gap-1 text-lg font-medium">
      <x-icon name="tabler:brand-github" class="size-6" />
    </a>
    <a :href="uri([RedirectsController::class, 'bluesky'])" class="flex items-center gap-1 text-lg font-medium">
      <x-icon name="tabler:brand-bluesky" class="size-6" />
    </a>
    <a :href="uri([RedirectsController::class, 'twitter'])" class="flex items-center gap-1 text-lg font-medium">
      <x-icon name="tabler:brand-x" class="size-6" />
    </a>
		<button id="toggle-theme" class="relative size-6 cursor-pointer overflow-hidden">
