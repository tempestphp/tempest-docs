...
final class MigratePackageDownloadsListedEvents implements DatabaseMigration
{
    public string $name = '2024-12-14_01_migrate_package_downloads_per_day_date_field';

    public function up(): QueryStatement|null
    {
        $events = arr(StoredEvent::query()->where('eventClass = :eventClass', eventClass: PackageDownloadsListed::class)->all());
