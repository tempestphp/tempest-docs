            ...
            <div class=" flex-1 flex flex-col items-center justify-center gap-8">
                ...
                <div class="flex gap-3 my-8 flex-col text-center items-center ">
                    <div class="bg-tempest-blue-950/[90%] px-4 py-2 rounded-[9px] text-white border border-tempest-blue-500 font-medium font-mono text-[16px]">
                        <span class="text-tempest-blue-100 font-normal">composer</span> require tempest/view:1.0-alpha.5
                    </div>
                </div>

                <div class="flex sm:flex-row flex-col gap-2">
                    <x-button uri="<?= uri(ChapterController::class, category: 'framework', slug: 'views') ?>">Read the docs</x-button>
