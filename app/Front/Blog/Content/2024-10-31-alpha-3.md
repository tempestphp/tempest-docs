...
That being said, there's still a lot of work to be done before a stable 1.0 release. We aim for the next alpha release to be available end of November, right after the PHP 8.4 release. These are the things we want to solve by then:
